  ...
  const cardArray = [
    {
      ...
      imageUrl:todoApp,
      paraGraph:"A simple To-Do app where users can: Sign up, log in, and log out securely. Create, view, delete, and mark tasks as done. Access all previously created tasks. Easy to use and built for efficient task management!",
